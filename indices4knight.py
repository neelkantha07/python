# -*- coding: utf-8 -*-
"""
Created on Mon Feb 17 19:14:34 2025
...
def analyze_tickers():
    ...
    for ticker in tickers:
        try:
            ...
            elif (stoch1.iloc[-1] < 20 and stoch4.iloc[-1] > 80):
    ...
    save_to_csv("best_20_downindices.csv", best20)
    save_to_csv("best_20_upindices.csv", best201)
    save_to_csv("vol_upindices.csv", volup)
...
def load_tickers():
    ...
    if file_path:
        ...
        tickers = [str(t).strip() + "" for t in df[0].tolist()]
        listbox_tickers.delete(0, tk.END)
        for ticker in tickers:
